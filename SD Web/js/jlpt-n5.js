const jlptN5VocabList = [
    ...
    { word: "ちゃいけない (cha ikenai)", correct: "mustn’t ..", incorrect: ["should ..", "can ..", "might .."], explanation: "ちゃいけない (cha ikenai) means 'mustn’t ..' in Japanese. Example: ここに入っちゃいけない。 (Koko ni haitcha ikenai.) - You mustn't enter here." },
    { word: "ましょうか (mashouka)", correct: "shall I?", incorrect: ["can I?", "will I?", "did I?"], explanation: "ましょうか (mashouka) means 'shall I?' in Japanese. Example: 手伝いましょうか？ (Tetsudaimashouka?) - Shall I help you?" },
    { word: "どうして (doushite)", correct: "how; in what way; by what means", incorrect: ["when", "where", "who"], explanation: "どうして (doushite) means 'how; in what way; by what means' in Japanese. Example: どうして遅れたの？ (Doushite okureta no?) - How did you get late?" },
    { word: "けど (kedo)", correct: "but; however", incorrect: ["and", "or", "because"], explanation: "けど (kedo) means 'but; however' in Japanese. Example: 高いけど、買いたい。 (Takai kedo, kaitai.) - It's expensive, but I want to buy it." },
    { word: "に/へ (ni/e)", correct: "to (a place)", incorrect: ["from", "with", "by"], explanation: "に/へ (ni/e) means 'to (a place)' in Japanese. Example: 学校に行く。 (Gakkou ni iku.) - I go to school." },
    { word: "たい (tai)", correct: "want to", incorrect: ["need to", "have to", "can"], explanation: "たい (tai) means 'want to' in Japanese. Example: 日本へ行きたい。 (Nihon e ikitai.) - I want to go to Japan." },
    { word: "がいます / がいる (ga imasu / ga iru)", correct: "there is (for a living body)", incorrect: ["there is (for an object)", "there was", "there will be"], explanation: "がいます / がいる (ga imasu / ga iru) means 'there is (for a living body)' in Japanese. Example: 犬がいます。 (Inu ga imasu.) - There is a dog." },
    { word: "のです (no desu)", correct: "the expectation is that …; the reason is that …", incorrect: ["it seems that", "I guess", "it might be"], explanation: "のです (no desu) means 'the expectation is that …; the reason is that …' in Japanese. Example: 今日は雨が降るのです。 (Kyou wa ame ga furu no desu.) - The reason is that it will rain today." },
    { word: "すぎる (sugiru)", correct: "to pass through; to pass by; to go beyond", incorrect: ["to stop", "to start", "to stay"], explanation: "すぎる (sugiru) means 'to pass through; to pass by; to go beyond' in Japanese. Example: 電車が駅を過ぎる。 (Densha ga eki wo sugiru.) - The train passes by the station." },
    { word: "ませんか (masen ka)", correct: "won’t (hasn’t, isn’t, doesn’t, etc.)", incorrect: ["will", "can", "should"], explanation: "ませんか (masen ka) means 'won’t (hasn’t, isn’t, doesn’t, etc.)' in Japanese. Example: 一緒に行きませんか？ (Issho ni ikimasen ka?) - Won’t you go with me?" },
    { word: "なぁ (naa)", correct: "hey; say; look", incorrect: ["listen", "come", "go"], explanation: "なぁ (naa) means 'hey; say; look' in Japanese. Example: いい天気だなぁ。 (Ii tenki da naa.) - Hey, it’s good weather." },
    { word: "お/ご (o/go)", correct: "honorific prefix", incorrect: ["suffix", "particle", "adjective"], explanation: "お/ご (o/go) is an honorific prefix in Japanese. Example: お茶 (ocha) - tea (polite form)." },
    { word: "か (ka)", correct: "used as a question mark", incorrect: ["statement", "exclamation", "command"], explanation: "か (ka) is used as a question mark in Japanese. Example: これは何ですか？ (Kore wa nan desu ka?) - What is this?" },
    { word: "〇〇方が〇〇 (-hou ga -)", correct: "A is more B (than something else)", incorrect: ["A is less B", "A is the same as B", "A is not B"], explanation: "〇〇方が〇〇 (-hou ga -) means 'A is more B (than something else)' in Japanese. Example: 犬の方が猫より大きいです。 (Inu no hou ga neko yori ookii desu.) - The dog is bigger than the cat." },
    { word: "で (de)", correct: "in, with", incorrect: ["on", "under", "between"], explanation: "で (de) means 'in, with' in Japanese. Example: 日本で勉強します。 (Nihon de benkyou shimasu.) - I study in Japan." },
    { word: "なる (naru)", correct: "to become; to get; to grow; to be; to reach; to attain", incorrect: ["to stay", "to leave", "to return"], explanation: "なる (naru) means 'to become; to get; to grow; to be; to reach; to attain' in Japanese. Example: 先生になりたい。 (Sensei ni naritai.) - I want to become a teacher." },
    { word: "しかし (shikashi)", correct: "however; but", incorrect: ["therefore", "because", "and"], explanation: "しかし (shikashi) means 'however; but' in Japanese. Example: 雨が降っている。しかし、出かけます。 (Ame ga futteiru. Shikashi, dekakemasu.) - It is raining. However, I will go out." },
    { word: "ている (te iru)", correct: "is .. -ing", incorrect: ["was .. -ing", "will be .. -ing", "has been .. -ing"], explanation: "ている (te iru) means 'is .. -ing' in Japanese. Example: 私は本を読んでいる。 (Watashi wa hon wo yondeiru.) - I am reading a book." },
    { word: "〇〇は〇〇より〇〇です (-wa -yori -desu)", correct: ".. compared to .. is more ..", incorrect: [".. compared to .. is less ..", ".. compared to .. is the same ..", ".. compared to .. is not .."], explanation: "〇〇は〇〇より〇〇です (-wa -yori -desu) means '.. compared to .. is more ..' in Japanese. Example: このリンゴはあのリンゴより大きいです。 (Kono ringo wa ano ringo yori ookii desu.) - This apple is bigger than that apple." },
    { word: "はどうですか (wa dou desu ka)", correct: "what about .. ?", incorrect: ["how is .. ?", "where is .. ?", "who is .. ?"], explanation: "はどうですか (wa dou desu ka) means 'what about .. ?' in Japanese. Example: 映画はどうですか？ (Eiga wa dou desu ka?) - What about a movie?" },
    { word: "どうやって (douyatte)", correct: "how; in what way; by what means", incorrect: ["when", "where", "who"], explanation: "どうやって (douyatte) means 'how; in what way; by what means' in Japanese. Example: どうやってここに来たの？ (Douyatte koko ni kita no?) - How did you come here?" },
    { word: "から (kara)", correct: "from (e.g. time, place, numerical quantity); since", incorrect: ["until", "for", "by"], explanation: "から (kara) means 'from (e.g. time, place, numerical quantity); since' in Japanese. Example: 学校から帰る。 (Gakkou kara kaeru.) - I return from school." },
    { word: "つもり (tsumori)", correct: "intention; plan", incorrect: ["mistake", "accident", "coincidence"], explanation: "つもり (tsumori) means 'intention; plan' in Japanese. Example: 明日行くつもりです。 (Ashita iku tsumori desu.) - I plan to go tomorrow." },
    { word: "にする (ni suru)", correct: "to make something as ..", incorrect: ["to break something as ..", "to lose something as ..", "to find something as .."], explanation: "にする (ni suru) means 'to make something as ..' in Japanese. Example: これにします。 (Kore ni shimasu.) - I'll take this." },
    { word: "にいく (ni iku)", correct: "to go for +verb-ing, to go + verb-ing", incorrect: ["to come for", "to stay for", "to leave for"], explanation: "にいく (ni iku) means 'to go for +verb-ing, to go + verb-ing' in Japanese. Example: 買い物に行く。 (Kaimono ni iku.) - I go shopping." },
    { word: "でしょう (deshou)", correct: "it seems; I think; I guess; I wonder", incorrect: ["it is", "it was", "it will be"], explanation: "でしょう (deshou) means 'it seems; I think; I guess; I wonder' in Japanese. Example: 明日は雨でしょう。 (Ashita wa ame deshou.) - It seems it will rain tomorrow." },
    { word: "まだ (mada)", correct: "still; as yet; hitherto; only", incorrect: ["already", "soon", "now"], explanation: "まだ (mada) means 'still; as yet; hitherto; only' in Japanese. Example: まだ終わっていません。 (Mada owatteimasen.) - It's still not finished." },
    { word: "なくては (nakute wa)", correct: "unless; without", incorrect: ["with", "by", "through"], explanation: "なくては (nakute wa) means 'unless; without' in Japanese. Example: 努力なくては成功しない。 (Doryoku nakute wa seikou shinai.) - Without effort, there is no success." },
    { word: "に (ni)", correct: "towards (someone), to (someone)", incorrect: ["from", "with", "by"], explanation: "に (ni) means 'towards (someone), to (someone)' in Japanese. Example: 友達に会う。 (Tomodachi ni au.) - I meet my friend." },
    { word: "てもいいです (temo ii desu)", correct: "it is ok to do ..", incorrect: ["it is not ok to do ..", "it is mandatory to do ..", "it is forbidden to do .."], explanation: "てもいいです (temo ii desu) means 'it is ok to do ..' in Japanese. Example: ここで写真を撮ってもいいですか？ (Koko de shashin wo totte mo ii desu ka?) - Is it ok to take a photo here?" },
    { word: "ほうがいい (hou ga ii)", correct: "had better", incorrect: ["had worse", "had the same", "had less"], explanation: "ほうがいい (hou ga ii) means 'had better' in Japanese. Example: 医者に行ったほうがいい。 (Isha ni itta hou ga ii.) - You had better go to the doctor." },
    { word: "のがじょうず (no ga jouzu)", correct: "being good at ..", incorrect: ["being bad at ..", "being average at ..", "being excellent at .."], explanation: "のがじょうず (no ga jouzu) means 'being good at ..' in Japanese. Example: 彼は歌うのがじょうずです。 (Kare wa utau no ga jouzu desu.) - He is good at singing." },
    { word: "は (wa)", correct: "topic marker particle", incorrect: ["subject marker particle", "object marker particle", "direction marker particle"], explanation: "は (wa) is a topic marker particle in Japanese. Example: 私は学生です。 (Watashi wa gakusei desu.) - I am a student." },
    { word: "〇〇より〇〇方がマシ (-yori -hou ga mashi)", correct: "I would rather; I would as lief do; strong preference", incorrect: ["I would not do", "I would dislike", "I would hate"], explanation: "〇〇より〇〇方がマシ (-yori -hou ga mashi) means 'I would rather; I would as lief do; strong preference' in Japanese. Example: 雨より雪のほうがマシです。 (Ame yori yuki no hou ga mashi desu.) - I would rather have snow than rain." },
    { word: "てから (te kara)", correct: "after .. is done", incorrect: ["before .. is done", "while .. is done", "during .. is done"], explanation: "てから (te kara) means 'after .. is done' in Japanese. Example: 食事をしてから、勉強します。 (Shokuji wo shite kara, benkyou shimasu.) - After eating, I study." },
    { word: "じゃない (janai / dewa nai)", correct: "is not; am not; are not", incorrect: ["is", "am", "are"], explanation: "じゃない (janai / dewa nai) means 'is not; am not; are not' in Japanese. Example: それは本当じゃない。 (Sore wa hontou janai.) - That is not true." },
    { word: "けれども (keredo mo)", correct: "however; although", incorrect: ["therefore", "because", "and"], explanation: "けれども (keredo mo) means 'however; although' in Japanese. Example: 雨が降っているけれども、出かけます。 (Ame ga futteiru keredo mo, dekakemasu.) - Although it is raining, I will go out." },
    { word: "を (wo)", correct: "indicates direct object of action", incorrect: ["indicates subject of action", "indicates location", "indicates direction"], explanation: "を (wo) indicates direct object of action in Japanese. Example: 本を読む。 (Hon wo yomu.) - I read a book." },
    { word: "よ (yo)", correct: "put an emphasis on the confidence ones have into what he or she is saying", incorrect: ["question marker", "negation", "exclamation"], explanation: "よ (yo) is used to put an emphasis on the confidence ones have into what he or she is saying in Japanese. Example: これは本当ですよ。 (Kore wa hontou desu yo.) - This is true, you know." },
    { word: "だろう (darou)", correct: "seems; I think; I guess; I wonder; I hope", incorrect: ["is", "was", "will be"], explanation: "だろう (darou) means 'seems; I think; I guess; I wonder; I hope' in Japanese. Example: 明日は晴れるだろう。 (Ashita wa hareru darou.) - It seems it will be sunny tomorrow." },
    { word: "なくてはならない (nakute wa naranai)", correct: "cannot do without something; indispensable; absolutely necessary", incorrect: ["not necessary", "avoidable", "optional"], explanation: "なくてはならない (nakute wa naranai) means 'cannot do without something; indispensable; absolutely necessary' in Japanese. Example: 水は生きるために必要なくてはならない。 (Mizu wa ikiru tame ni hitsuyou nakute wa naranai.) - Water is indispensable for living." },
    { word: "んです (ndesu)", correct: "the expectation is that …; the reason is that …", incorrect: ["it seems that", "I guess", "it might be"], explanation: "んです (ndesu) means 'the expectation is that …; the reason is that …' in Japanese. Example: 今日は雨が降るんです。 (Kyou wa ame ga furu n desu.) - The reason is that it will rain today." },
    { word: "や (ya)", correct: "or", incorrect: ["and", "but", "because"], explanation: "や (ya) means 'or' in Japanese. Example: 本やノートがあります。 (Hon ya nooto ga arimasu.) - There are books and notebooks." },
    { word: "がほしい (ga hoshii)", correct: "I want ..", incorrect: ["I have ..", "I give ..", "I get .."], explanation: "がほしい (ga hoshii) means 'I want ..' in Japanese. Example: 新しい車がほしい。 (Atarashii kuruma ga hoshii.) - I want a new car." },
    { word: "もう (mou)", correct: "now; soon; shortly; before long; presently", incorrect: ["never", "always", "sometimes"], explanation: "もう (mou) means 'now; soon; shortly; before long; presently' in Japanese. Example: もうすぐ来ます。 (Mou sugu kimasu.) - He will come soon." },
    { word: "〇〇のなかで〇〇がいちばん (-no naka de -ga ichiban)", correct: "among .., .. is the best", incorrect: ["among .., .. is the worst", "among .., .. is average", "among .., .. is good"], explanation: "〇〇のなかで〇〇がいちばん (-no naka de -ga ichiban) means 'among .., .. is the best' in Japanese. Example: クラスの中で彼が一番背が高い。 (Kurasu no naka de kare ga ichiban se ga takai.) - He is the tallest in the class." },
    { word: "とても (totemo)", correct: "very; awfully; exceedingly", incorrect: ["not very", "slightly", "barely"], explanation: "とても (totemo) means 'very; awfully; exceedingly' in Japanese. Example: とても寒いです。 (Totemo samui desu.) - It is very cold." },
    { word: "どんな (donna)", correct: "what; what kind of", incorrect: ["why", "when", "where"], explanation: "どんな (donna) means 'what; what kind of' in Japanese. Example: どんな本が好きですか？ (Donna hon ga suki desu ka?) - What kind of books do you like?" },
    { word: "〇〇たり〇〇たり (tari-tari)", correct: "-ing and -ing", incorrect: ["-ed and -ed", "-ing or -ing", "-ed or -ed"], explanation: "〇〇たり〇〇たり (tari-tari) means '-ing and -ing' in Japanese. Example: 映画を見たり、本を読んだりする。 (Eiga wo mitari, hon wo yondari suru.) - I do things like watch movies and read books." },
    { word: "いちばん (ichiban)", correct: "number one; first; first place", incorrect: ["last", "second", "third"], explanation: "いちばん (ichiban) means 'number one; first; first place' in Japanese. Example: 彼がいちばん速い。 (Kare ga ichiban hayai.) - He is the fastest." },
    { word: "いつも (itsumo)", correct: "always; usually; every time", incorrect: ["never", "sometimes", "rarely"], explanation: "いつも (itsumo) means 'always; usually; every time' in Japanese. Example: 彼はいつも元気です。 (Kare wa itsumo genki desu.) - He is always energetic." },
    { word: "なくてもいい (naku temo ii)", correct: "need not; (not) have to", incorrect: ["must", "should", "have to"], explanation: "なくてもいい (naku temo ii) means 'need not; (not) have to' in Japanese. Example: 今日、学校に行かなくてもいいです。 (Kyou, gakkou ni ikanakute mo ii desu.) - You don’t have to go to school today." },
    { word: "のが好き (no ga suki)", correct: "like; love", incorrect: ["dislike", "hate", "ignore"], explanation: "のが好き (no ga suki) means 'like; love' in Japanese. Example: 私は歌うのが好きです。 (Watashi wa utau no ga suki desu.) - I like singing." },
    { word: "じゃいけない (ja ikenai)", correct: "mustn’t ..", incorrect: ["should ..", "can ..", "might .."], explanation: "じゃいけない (ja ikenai) means 'mustn’t ..' in Japanese. Example: ここに入っちゃいけない。 (Koko ni haitcha ikenai.) - You mustn't enter here." },
    { word: "でも (demo)", correct: "but; however; though; nevertheless; still; yet; even so; also; as well", incorrect: ["therefore", "because", "so"], explanation: "でも (demo) means 'but; however; though; nevertheless; still; yet; even so; also; as well' in Japanese. Example: 雨が降っている。でも、行きます。 (Ame ga futteiru. Demo, ikimasu.) - It’s raining. However, I will go." },
    { word: "てはいけない (te wa ikenai)", correct: "must not ..", incorrect: ["can ..", "should ..", "might .."], explanation: "てはいけない (te wa ikenai) means 'must not ..' in Japanese. Example: ここでタバコを吸ってはいけません。 (Koko de tabako wo sutte wa ikemasen.) - You must not smoke here." },
    { word: "まだ〇〇ていません (mada -te imasen)", correct: "still not .. ?", incorrect: ["already ..", "just ..", "never .."], explanation: "まだ〇〇ていません (mada -te imasen) means 'still not .. ?' in Japanese. Example: まだ宿題を終えていません。 (Mada shukudai wo oeteimasen.) - I still haven't finished my homework." },
    { word: "ましょう (mashou)", correct: "let’s .. !", incorrect: ["shall we .. ?", "can we .. ?", "should we .. ?"], explanation: "ましょう (mashou) means 'let’s .. !' in Japanese. Example: 一緒に映画を見ましょう。 (Issho ni eiga wo mimashou.) - Let’s watch a movie together." },
    { word: "の (no)", correct: "indicates possessive", incorrect: ["indicates subject", "indicates object", "indicates direction"], explanation: "の (no) indicates possessive in Japanese. Example: これは私の本です。 (Kore wa watashi no hon desu.) - This is my book." },
    { word: "も (mo)", correct: "too; also; in addition; as well; (not) either (in a negative sentence)", incorrect: ["but", "because", "so"], explanation: "も (mo) means 'too; also; in addition; as well; (not) either (in a negative sentence)' in Japanese. Example: 私も行きます。 (Watashi mo ikimasu.) - I will go too." },
    { word: "〇〇か〇〇か (-ka -ka)", correct: "either .. either ..", incorrect: ["both .. and ..", "neither .. nor ..", "only .. but .."], explanation: "〇〇か〇〇か (-ka -ka) means 'either .. either ..' in Japanese. Example: 日本語か英語かどちらが好きですか？ (Nihongo ka eigo ka dochira ga suki desu ka?) - Do you like Japanese or English?" },
    { word: "まで (made)", correct: "until (a time); till; to; up to", incorrect: ["from", "since", "after"], explanation: "まで (made) means 'until (a time); till; to; up to' in Japanese. Example: 午後5時まで働きます。 (Gogo go-ji made hatarakimasu.) - I work until 5 PM." },
    { word: "ないで (naide)", correct: "without doing …", incorrect: ["after doing ..", "before doing ..", "while doing .."], explanation: "ないで (naide) means 'without doing …' in Japanese. Example: 朝ご飯を食べないで学校に行きました。 (Asagohan wo tabenaide gakkou ni ikimashita.) - I went to school without having breakfast." },
    { word: "ね (ne)", correct: "isn’t it ?", incorrect: ["is it?", "was it?", "will it?"], explanation: "ね (ne) means 'isn’t it ?' in Japanese. Example: 今日は寒いですね。 (Kyou wa samui desu ne.) - It’s cold today, isn’t it?" },
    { word: "があります (ga arimasu)", correct: "I have .., there is.. (for a non-living body)", incorrect: ["I am ..", "I was ..", "I will be .."], explanation: "があります (ga arimasu) means 'I have .., there is.. (for a non-living body)' in Japanese. Example: 部屋に机があります。 (Heya ni tsukue ga arimasu.) - There is a desk in the room." },
    { word: "前に (mae ni)", correct: "before ..", incorrect: ["after ..", "during ..", "since .."], explanation: "前に (mae ni) means 'before ..' in Japanese. Example: 食事の前に手を洗ってください。 (Shokuji no mae ni te wo aratte kudasai.) - Please wash your hands before eating." },
    { word: "ので (node)", correct: "that being the case; because of …; the reason is …; given that …", incorrect: ["despite", "although", "even though"], explanation: "ので (node) means 'that being the case; because of …; the reason is …; given that …' in Japanese. Example: 雨が降っているので、出かけません。 (Ame ga futteiru node, dekakemasen.) - I won’t go out because it’s raining." },
    { word: "ください (o kudasai)", correct: "please (give me)", incorrect: ["thank you", "sorry", "excuse me"], explanation: "ください (o kudasai) means 'please (give me)' in Japanese. Example: 水をください。 (Mizu wo kudasai.) - Please give me water." },
    { word: "てある (te aru)", correct: "has been ..", incorrect: ["will be ..", "is being ..", "was being .."], explanation: "てある (te aru) means 'has been ..' in Japanese. Example: ドアが開けてあります。 (Doa ga akete arimasu.) - The door has been opened." },
    { word: "かた (kata)", correct: "a person", incorrect: ["a place", "a thing", "a reason"], explanation: "かた (kata) means 'a person' in Japanese. Example: 彼は親切な方です。 (Kare wa shinsetsu na kata desu.) - He is a kind person." },
    { word: "ないといけない (naito ikenai)", correct: "have to (verb); must (verb)", incorrect: ["must not (verb)", "don’t have to (verb)", "can (verb)"], explanation: "ないといけない (naito ikenai) means 'have to (verb); must (verb)' in Japanese. Example: 宿題をしないといけない。 (Shukudai wo shinaito ikenai.) - I have to do my homework." },
    { word: "のがへた (no ga heta)", correct: "being bad at ..", incorrect: ["being good at ..", "being average at ..", "being excellent at .."], explanation: "のがへた (no ga heta) means 'being bad at ..' in Japanese. Example: 彼は料理をするのがへたです。 (Kare wa ryouri wo suru no ga heta desu.) - He is bad at cooking." },
    { word: "だけ (dake)", correct: "only; just; merely; simply; no more than; nothing but; alone", incorrect: ["more than", "less than", "equal to"], explanation: "だけ (dake) means 'only; just; merely; simply; no more than; nothing but; alone' in Japanese. Example: これだけでいいです。 (Kore dake de ii desu.) - Only this is fine." },
    { word: "とき (toki)", correct: "when", incorrect: ["where", "how", "why"], explanation: "とき (toki) means 'when' in Japanese. Example: 私は寝るときに本を読みます。 (Watashi wa neru toki ni hon wo yomimasu.) - I read a book when I go to bed." },
    { word: "が (ga)", correct: "indicates sentence subject (occasionally object)", incorrect: ["indicates direction", "indicates possessive", "indicates location"], explanation: "が (ga) indicates sentence subject (occasionally object) in Japanese. Example: 犬がいる。 (Inu ga iru.) - There is a dog." },
    { word: "いっしょに (issho ni)", correct: "together (with); at the same time; in a lump", incorrect: ["alone", "separately", "individually"], explanation: "いっしょに (issho ni) means 'together (with); at the same time; in a lump' in Japanese. Example: 一緒に行きましょう。 (Issho ni ikimashou.) - Let’s go together." },
    { word: "なくてはいけない (nakute wa ikenai)", correct: "cannot do without something; indispensable; absolutely necessary", incorrect: ["not necessary", "avoidable", "optional"], explanation: "なくてはいけない (nakute wa ikenai) means 'cannot do without something; indispensable; absolutely necessary' in Japanese. Example: 健康はなくてはいけない。 (Kenko wa nakute wa ikenai.) - Health is indispensable." },
    { word: "〇〇方がいい (-hou ga ii)", correct: "would be better to", incorrect: ["would be worse to", "would be the same to", "would be unnecessary to"], explanation: "〇〇方がいい (-hou ga ii) means 'would be better to' in Japanese. Example: 早く寝た方がいい。 (Hayaku neta hou ga ii.) - It would be better to sleep early." },
    { word: "だ / です (da / desu)", correct: "be; is", incorrect: ["was", "will be", "isn't"], explanation: "だ / です (da / desu) means 'be; is' in Japanese. Example: これは本です。 (Kore wa hon desu.) - This is a book." },
    { word: "でも (demo)", correct: "but; however; though; nevertheless; still; yet; even so; also; as well", incorrect: ["therefore", "because", "so"], explanation: "でも (demo) means 'but; however; though; nevertheless; still; yet; even so; also; as well' in Japanese. Example: 雨が降っている。でも、行きます。 (Ame ga futteiru. Demo, ikimasu.) - It’s raining. However, I will go." },
    { word: "ないでください (naide kudasai)", correct: "please don’t ..", incorrect: ["please do ..", "please consider ..", "please stop .."], explanation: "ないでください (naide kudasai) means 'please don’t ..' in Japanese. Example: ここで写真を撮らないでください。 (Koko de shashin wo toranaide kudasai.) - Please don’t take pictures here." },
    { word: "ことがある (ta koto ga aru)", correct: "to have occurred; to have done (something)", incorrect: ["never occurred", "to have started", "to have finished"], explanation: "ことがある (ta koto ga aru) means 'to have occurred; to have done (something)' in Japanese. Example: 日本に行ったことがある。 (Nihon ni itta koto ga aru.) - I have been to Japan." }
